package com.ies.curso.tema16.micronaut.config;
...
public class MyBatisFactory {
    ...
    String PRUEBA_REACTIVE_MAPPER="mappers/com/ies/curso/tema16/micronaut/prueba_reactive.xml";
